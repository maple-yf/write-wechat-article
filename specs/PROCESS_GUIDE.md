...
**重复率检查**
- [ ] 对文章内容进行查重，使用 browser-use、deep-research、agent-reach、defuddle skills对文章内容进行重复率检查
- [ ] 输出重复率
- [ ] 重复率超过10%，则针对重复的内容进行修改
- [ ] 直到重复率满足要求
- [ ] 如果经过5轮修改，重复率仍然超过10%，则输出重复率检查未通过，需要重新写该文章
